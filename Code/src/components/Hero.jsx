      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <a href={`${import.meta.env.BASE_URL}images/Resume/Nisha Resume.pdf`} className="btn btn-outline" rel="noopener noreferrer" download="Nisha_Prajapati_Resume.pdf">
        ...
        <div className="hero-image-wrapper">
          <div className="hero-image-container">
            <img src={`${import.meta.env.BASE_URL}images/profile/Profile.png`} alt="Nisha Prajapati" className="hero-image" />
          </div>
        </div>
      </div>
